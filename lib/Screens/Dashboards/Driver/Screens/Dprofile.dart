...
class _ProfileScreenState extends State<DriverProfileScreen> {
  ...
  void initState() {
    super.initState();
    nameController.text = widget.userProfileData['driverName'] ?? 'N/A';
  ...
  Future<void> _changeProfileImage() async {
    ...
    if (downloadUrl != null) {
      ...
      if (currentUser != null) {
        ...
        setState(() {
          widget.userProfileData['driverImage'] =
  ...
  Future<void> _saveProfileChanges() async {
    ...
    try {
      ...
      if (currentUser != null) {
        ...
        setState(() {
          widget.userProfileData['driverName'] = nameController.text;
            ...
            Stack(
              children: [
                CircleAvatar(
                  backgroundColor: Colors.white,
                  radius: 55,
                  backgroundImage: widget.userProfileData['driverImage']
                      .startsWith('http')
